...
public class CommandBossBar extends ServerBossBar {
	...
	public CommandBossBar(Identifier id, Text displayName) {
		super(displayName, Color.WHITE, Style.PROGRESS);
		this.id = id;
	...
	public static CommandBossBar fromNbt(NbtCompound nbt, Identifier id) {
		...
		commandBossBar.setColor(Color.byName(nbt.getString("Color")));
		commandBossBar.setStyle(Style.byName(nbt.getString("Overlay")));
