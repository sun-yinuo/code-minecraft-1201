	...
	public static record Data(
		...
		public static final Codec<Data> CODEC = RecordCodecBuilder.create(
			instance -> instance.group(
						...
						Codec.BOOL.optionalFieldOf("IsRespawning", Boolean.valueOf(false)).forGetter(Data::isRespawning),
						Uuids.INT_STREAM_CODEC.optionalFieldOf("Dragon").forGetter(Data::dragonUUID),
						BlockPos.CODEC.optionalFieldOf("ExitPortalLocation").forGetter(Data::exitPortalLocation),
						Codec.list(Codec.INT).optionalFieldOf("Gateways").forGetter(Data::gateways)
					)
