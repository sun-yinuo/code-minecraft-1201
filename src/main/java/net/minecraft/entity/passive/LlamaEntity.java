...
public class LlamaEntity extends AbstractDonkeyEntity implements VariantHolder<LlamaEntity.Variant>, RangedAttackMob {
	...
	static class LlamaData extends PassiveData {
	...
	public static enum Variant implements StringIdentifiable {
		...
		public static final com.mojang.serialization.Codec<Variant> CODEC = StringIdentifiable.createCodec(Variant::values);
		private static final IntFunction<Variant> BY_ID = ValueLists.createIdToValueFunction(
			Variant::getIndex, values(), ValueLists.OutOfBoundsHandling.CLAMP
		);
		final int id;
