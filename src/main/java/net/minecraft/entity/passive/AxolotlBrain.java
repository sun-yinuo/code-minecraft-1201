 ...
 * </tr>
 * <tr>
 *   <td>{@link Activity#CORE}</td>
 *   <td><ul>
 *     <li>{@link LookAroundTask}</li>
 *     <li>{@link WanderAroundTask}</li>
 *     <li>{@link PlayDeadTimerTask}</li>
 *     <li>{@link TemptationCooldownTask}</li>
 *   </ul></td>
 * </tr>
 * <tr>
 *   <td>{@link Activity#IDLE}</td>
 *   <td><ul>
 *     <li>{@link net.minecraft.entity.ai.brain.task.LookAtMobTask LookAtMobTask(PLAYER)} (time limited)</li>
 *     <li>{@link BreedTask}</li>
 *     <li>{@link TemptTask} (random)</li>
 *     <li>{@link WalkTowardClosestAdultTask}</li>
 *     <li>{@link UpdateAttackTargetTask}</li>
 *     <li>{@link SeekWaterTask}</li>
 *     <li>{@link CompositeTask}</li>
 *   </ul></td>
 * </tr>
 * <tr>
 *   <td>{@link Activity#FIGHT}</td>
 *   <td><ul>
 *     <li>{@link ForgetAttackTargetTask}</li>
 *     <li>{@link RangedApproachTask}</li>
 *     <li>{@link MeleeAttackTask}</li>
 *     <li>{@link ForgetTask}</li>
 *   </ul></td>
 * </tr>
 * <tr>
 *   <td>{@link Activity#PLAY_DEAD}</td>
 *   <td><ul>
 *     <li>{@link PlayDeadTask}</li>
 *     <li>{@link ForgetTask}</li>
 *   </ul></td>
 * </tr>
 * </table>
