...
public class FoxEntity extends AnimalEntity implements VariantHolder<FoxEntity.Type> {
	...
	protected void initGoals() {
		...
		this.goalSelector.add(7, new AttackGoal(1.2F, true));
		...
		this.goalSelector.add(10, new EatBerriesGoal(1.2F, 12, 1));
		...
		this.targetSelector
			.add(
				3,
				new DefendFriendGoal(LivingEntity.class, false, false, entity -> JUST_ATTACKED_SOMETHING_FILTER.test(entity) && !this.canTrust(entity.getUuid()))
			);
	}
	...
	public static class FoxData extends PassiveData {
