...
public class SnifferBrain {
	...
	private static void addSniffActivities(Brain<SnifferEntity> brain) {
		brain.setTaskList(
			Activity.SNIFF,
			ImmutableList.of(Pair.of(0, new SearchingTask())),
			Set.of(
	...
	private static void addDigActivities(Brain<SnifferEntity> brain) {
		brain.setTaskList(
			Activity.DIG,
			ImmutableList.of(Pair.of(0, new DiggingTask(160, 180)), Pair.of(0, new FinishDiggingTask(40))),
			Set.of(
				Pair.of(MemoryModuleType.IS_PANICKING, MemoryModuleState.VALUE_ABSENT),
	...
	private static void addIdleActivities(Brain<SnifferEntity> brain) {
		brain.setTaskList(
			...
			ImmutableList.of(
				...
				Pair.of(3, new FeelHappyTask(40, 100)),
				Pair.of(
					4,
					new RandomTask<>(
						ImmutableList.of(
