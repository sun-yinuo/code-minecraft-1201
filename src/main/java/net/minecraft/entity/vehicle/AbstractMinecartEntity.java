				...
				if (!this.hasPassenger(entity)) {
					...
					if (f >= 1.0E-4F) {
						...
						if (entity instanceof AbstractMinecartEntity) {
							...
							if (((AbstractMinecartEntity)entity).getMinecartType() == Type.FURNACE
								&& this.getMinecartType() != Type.FURNACE) {
							...
							} else if (((AbstractMinecartEntity)entity).getMinecartType() != Type.FURNACE
								&& this.getMinecartType() == Type.FURNACE) {
