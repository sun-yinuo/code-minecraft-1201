...
public class MapState extends PersistentState {
	...
	private final List<PlayerUpdateTracker> updateTrackers = Lists.<PlayerUpdateTracker>newArrayList();
	private final Map<PlayerEntity, PlayerUpdateTracker> updateTrackersByPlayer = Maps.<PlayerEntity, PlayerUpdateTracker>newHashMap();
	/**
