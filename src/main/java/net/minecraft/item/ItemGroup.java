...
public class ItemGroup {
	...
	public interface Entries {
		...
		default void addAll(Collection<ItemStack> stacks, StackVisibility visibility) {
	...
	static class EntriesImpl implements Entries {
		...
		public void add(ItemStack stack, StackVisibility visibility) {
			if (stack.getCount() != 1) {
				...
				boolean bl = this.parentTabStacks.contains(stack) && visibility != StackVisibility.SEARCH_TAB_ONLY;
				if (bl) {
