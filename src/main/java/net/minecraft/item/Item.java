 ...
 * to be registered in the {@link Registries#ITEM} registry.
 * 
...
public class Item implements ToggleableFeature, ItemConvertible, FabricItem {
	...
	/**
	 * {@return the maximum stack count of any ItemStack with this item} Can be configured through {@link Settings#maxCount(int) settings.maxCount()}.
	 */
	...
	/**
	 * {@return the maximum durability of this item} Can be configured through {@link Settings#maxDamage(int) settings.maxDamage()}.
	 */
	...
	public static class Settings {
		...
		/**
		 * Calls {@link Settings#maxDamage} If this Settings instance has not already set max damage (or if max damage is the default value, 0).
		 * 
