...
public class VariantSettings {
	public static final VariantSetting<Rotation> X = new VariantSetting<>("x", rotation -> new JsonPrimitive(rotation.degrees));
	public static final VariantSetting<Rotation> Y = new VariantSetting<>("y", rotation -> new JsonPrimitive(rotation.degrees));
