...
public class BlockStateModelGenerator {
	...
	final Map<Block, StateFactory> stoneStateFactories = ImmutableMap.<Block, StateFactory>builder()
	...
	final Map<Block, TexturedModel> texturedModels = ImmutableMap.<Block, TexturedModel>builder()
		...
		.build();
	static final Map<BlockFamily.Variant, BiConsumer<BlockTexturePool, Block>> VARIANT_POOL_FUNCTIONS = ImmutableMap.<BlockFamily.Variant, BiConsumer<BlockTexturePool, Block>>builder()
		.put(BlockFamily.Variant.BUTTON, BlockTexturePool::button)
		.put(BlockFamily.Variant.DOOR, BlockTexturePool::door)
		.put(BlockFamily.Variant.CHISELED, BlockTexturePool::block)
		.put(BlockFamily.Variant.CRACKED, BlockTexturePool::block)
		.put(BlockFamily.Variant.CUSTOM_FENCE, BlockTexturePool::customFence)
		.put(BlockFamily.Variant.FENCE, BlockTexturePool::fence)
		.put(BlockFamily.Variant.CUSTOM_FENCE_GATE, BlockTexturePool::customFenceGate)
		.put(BlockFamily.Variant.FENCE_GATE, BlockTexturePool::fenceGate)
		.put(BlockFamily.Variant.SIGN, BlockTexturePool::sign)
		.put(BlockFamily.Variant.SLAB, BlockTexturePool::slab)
		.put(BlockFamily.Variant.STAIRS, BlockTexturePool::stairs)
		.put(BlockFamily.Variant.PRESSURE_PLATE, BlockTexturePool::pressurePlate)
		.put(BlockFamily.Variant.TRAPDOOR, BlockTexturePool::registerTrapdoor)
		.put(BlockFamily.Variant.WALL, BlockTexturePool::wall)
		.build();
	/**
	...
	public final LogTexturePool registerLog(Block logBlock) {
	...
	public final void registerTintableCross(Block block, TintType tintType, TextureMap texture) {
		this.registerItemModel(block);
	...
	public final void registerTintableCrossBlockState(Block block, TintType tintType, TextureMap crossTexture) {
	...
	public final void registerTintableCrossBlockStateWithStages(
		Block block, TintType tintType, Property<Integer> stageProperty, int... stages
	) {
	...
	public final void registerFlowerPotPlant(Block plantBlock, Block flowerPotBlock, TintType tintType) {
	...
	public final void registerDoubleBlock(Block doubleBlock, TintType tintType) {
	...
	public final BuiltinModelPool registerBuiltin(Identifier modelId, Block particleBlock) {
		return new BuiltinModelPool(modelId, particleBlock);
	}

	public final BuiltinModelPool registerBuiltin(Block block, Block particleBlock) {
	...
	public final void supplyChiseledBookshelfModel(
		...
		ChiseledBookshelfModelCacheKey chiseledBookshelfModelCacheKey = new ChiseledBookshelfModelCacheKey(
			model, string
		);
	...
	public final void registerPlantPart(Block plant, Block plantStem, TintType tintType) {
	...
	public final BlockStateVariant addJigsawOrientationToVariant(JigsawOrientation orientation, BlockStateVariant variant) {
		switch (orientation) {
			case DOWN_NORTH:
	...
	public class BlockTexturePool {
		...
		public BlockTexturePool base(Block block, Model model) {
			...
			if (BlockStateModelGenerator.this.stoneStateFactories.containsKey(block)) {
				BlockStateModelGenerator.this.blockStateCollector
					.accept(
						((StateFactory)BlockStateModelGenerator.this.stoneStateFactories.get(block))
		...
		public BlockTexturePool family(BlockFamily family) {
			...
			family.getVariants()
				.forEach(
					(variant, block) -> {
						BiConsumer<BlockTexturePool, Block> biConsumer = (BiConsumer<BlockTexturePool, Block>)BlockStateModelGenerator.VARIANT_POOL_FUNCTIONS
							.get(variant);
						if (biConsumer != null) {
