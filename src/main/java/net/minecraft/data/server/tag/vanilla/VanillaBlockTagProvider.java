...
public class VanillaBlockTagProvider extends ValueLookupTagProvider<Block> {
	...
	protected void configure(RegistryWrapper.WrapperLookup lookup) {
		...
		this.getOrCreateTagBuilder(BlockTags.TALL_FLOWERS).add(Blocks.SUNFLOWER, Blocks.LILAC, Blocks.PEONY, Blocks.ROSE_BUSH, Blocks.PITCHER_PLANT);
		...
		ObjectBuilder<Block> objectBuilder = this.getOrCreateTagBuilder(BlockTags.REPLACEABLE);
