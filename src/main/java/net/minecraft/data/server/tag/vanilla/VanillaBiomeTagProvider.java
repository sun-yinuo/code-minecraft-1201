...
public class VanillaBiomeTagProvider extends TagProvider<Biome> {
	...
	protected void configure(RegistryWrapper.WrapperLookup lookup) {
		...
		ProvidedTagBuilder<Biome> providedTagBuilder = this.getOrCreateTagBuilder(BiomeTags.IS_NETHER);
		MultiNoiseBiomeSourceParameterList.Preset.NETHER.biomeStream().forEach(providedTagBuilder::add);
		ProvidedTagBuilder<Biome> providedTagBuilder2 = this.getOrCreateTagBuilder(BiomeTags.IS_OVERWORLD);
