...
public class HoverEvent {
	...
	public static class Action<T> {
		...
		public static final Action<ItemStackContent> SHOW_ITEM = new Action<>(
			"show_item", true, ItemStackContent::parse, ItemStackContent::toJson, ItemStackContent::parse
		);
		public static final Action<EntityContent> SHOW_ENTITY = new Action<>(
			"show_entity", true, EntityContent::parse, EntityContent::toJson, EntityContent::parse
		);
		private static final Map<String, Action<?>> BY_NAME = (Map<String, Action<?>>)Stream.of(SHOW_TEXT, SHOW_ITEM, SHOW_ENTITY)
			.collect(ImmutableMap.toImmutableMap(Action::getName, action -> action));
