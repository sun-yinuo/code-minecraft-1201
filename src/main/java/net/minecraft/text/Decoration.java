...
public record Decoration(String translationKey, List<Parameter> parameters, Style style) {
	 ...
	 * parameters' {@link Parameter#apply} method.
	 */
	...
	public static enum Parameter implements StringIdentifiable {
		...
		public static final com.mojang.serialization.Codec<Parameter> CODEC = StringIdentifiable.createCodec(Parameter::values);
