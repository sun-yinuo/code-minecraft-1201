...
public class ConcentricRingsStructurePlacement extends StructurePlacement {
	...
	private static P9<Mu<ConcentricRingsStructurePlacement>, Vec3i, FrequencyReductionMethod, Float, Integer, Optional<ExclusionZone>, Integer, Integer, Integer, RegistryEntryList<Biome>> buildConcentricRingsCodec(
		...
		P5<Mu<ConcentricRingsStructurePlacement>, Vec3i, FrequencyReductionMethod, Float, Integer, Optional<ExclusionZone>> p5 = buildCodec(
			instance
		);
	...
	public ConcentricRingsStructurePlacement(
		Vec3i locateOffset,
		FrequencyReductionMethod generationPredicateType,
		float frequency,
		int salt,
	...
	public ConcentricRingsStructurePlacement(int distance, int spread, int structureCount, RegistryEntryList<Biome> preferredBiomes) {
		this(Vec3i.ZERO, FrequencyReductionMethod.DEFAULT, 1.0F, 0, Optional.empty(), distance, spread, structureCount, preferredBiomes);
	}
