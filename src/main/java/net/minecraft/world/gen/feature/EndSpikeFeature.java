...
public class EndSpikeFeature extends Feature<EndSpikeFeatureConfig> {
	...
	private static final LoadingCache<Long, List<Spike>> CACHE = CacheBuilder.newBuilder()
		.expireAfterWrite(5L, TimeUnit.MINUTES)
		.build(new SpikeCache());
	...
	public static class Spike {
		public static final Codec<Spike> CODEC = RecordCodecBuilder.create(
	...
	static class SpikeCache extends CacheLoader<Long, List<Spike>> {
		public List<Spike> load(Long long_) {
			...
			List<Spike> list = Lists.<Spike>newArrayList();
