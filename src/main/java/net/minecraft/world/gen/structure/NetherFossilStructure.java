...
public class NetherFossilStructure extends Structure {
	...
	public NetherFossilStructure(Config config, HeightProvider height) {
		super(config);
		this.height = height;
	}
	...
	public Optional<StructurePosition> getStructurePosition(Context context) {
		...
		if (l <= k) {
			...
			return Optional.of(
				new StructurePosition(blockPos, holder -> NetherFossilGenerator.addPieces(context.structureTemplateManager(), holder, chunkRandom, blockPos))
			);
		}
	}
