...
public abstract class Structure {
	...
	public static <S extends Structure> RecordCodecBuilder<S, Config> configCodecBuilder(Instance<S> instance) {
	...
	protected static Optional<StructurePosition> getStructurePosition(
		Context context, Heightmap.Type heightmap, Consumer<StructurePiecesCollector> generator
	) {
	...
	public static record Config(
		...
		public static final MapCodec<Config> CODEC = RecordCodecBuilder.mapCodec(
			instance -> instance.group(
						RegistryCodecs.entryList(RegistryKeys.BIOME).fieldOf("biomes").forGetter(Config::biomes),
						...
						StructureTerrainAdaptation.CODEC.optionalFieldOf("terrain_adaptation", StructureTerrainAdaptation.NONE).forGetter(Config::terrainAdaptation)
					)
