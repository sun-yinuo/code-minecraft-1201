...
public class GenerationSettings {
	...
	/**
	 * Returns the lists of features configured for each {@link GenerationStep.Feature feature generation step}, up to the highest step that has a configured feature.
