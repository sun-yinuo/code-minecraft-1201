...
public final class Biome {
	public static final Codec<Biome> CODEC = RecordCodecBuilder.create(
		instance -> instance.group(
					Weather.CODEC.forGetter(biome -> biome.weather),
	...
	public static final Codec<Biome> NETWORK_CODEC = RecordCodecBuilder.create(
		instance -> instance.group(Weather.CODEC.forGetter(biome -> biome.weather), BiomeEffects.CODEC.fieldOf("effects").forGetter(biome -> biome.effects))
	...
	public static class Builder {
		...
		public Biome build() {
			if (this.temperature != null && this.downfall != null && this.specialEffects != null && this.spawnSettings != null && this.generationSettings != null) {
				return new Biome(
					new Weather(this.precipitation, this.temperature, this.temperatureModifier, this.downfall),
					this.specialEffects,
	...
	public static enum TemperatureModifier implements StringIdentifiable {
		...
		public static final com.mojang.serialization.Codec<TemperatureModifier> CODEC = StringIdentifiable.createCodec(TemperatureModifier::values);
	...
	static record Weather(boolean hasPrecipitation, float temperature, TemperatureModifier temperatureModifier, float downfall) {
		public static final MapCodec<Weather> CODEC = RecordCodecBuilder.mapCodec(
			instance -> instance.group(
						...
						TemperatureModifier.CODEC.optionalFieldOf("temperature_modifier", TemperatureModifier.NONE).forGetter(weather -> weather.temperatureModifier),
