...
public final class SpawnHelper {
	...
	public static Info setupSpawn(
		int spawningChunkCount, Iterable<Entity> entities, ChunkSource chunkSource, SpawnDensityCapper densityCapper
	) {
	...
	public static class Info {
		...
		/**
		 * @see Checker#test(EntityType, BlockPos, Chunk)
		 */
		...
		/**
		 * @see Runner#run(MobEntity, Chunk)
		 */
