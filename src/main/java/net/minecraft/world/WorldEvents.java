...
public class WorldEvents {
	 ...
	 * <p>Called by {@link net.minecraft.item.EnderEyeItem#use(World, net.minecraft.entity.player.PlayerEntity, net.minecraft.util.Hand) EnderEyeItem#use}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.AbstractFireBlock#onBreak(World, net.minecraft.util.math.BlockPos, net.minecraft.block.BlockState, net.minecraft.entity.player.PlayerEntity) AbstractFireBlock#onBreak},
	 ...
	 * <p>Called by {@link net.minecraft.block.AnvilBlock#onDestroyedOnLanding(World, net.minecraft.util.math.BlockPos, net.minecraft.entity.FallingBlockEntity) AnvilBlock#onDestroyedOnLanding},
	 ...
	 * <p>Called by {@link net.minecraft.block.AnvilBlock#onLanding(World, net.minecraft.util.math.BlockPos, net.minecraft.block.BlockState, net.minecraft.block.BlockState, net.minecraft.entity.FallingBlockEntity) AnvilBlock#onLanding}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.ChorusFlowerBlock#grow(World, net.minecraft.util.math.BlockPos, int) ChorusFlowerBlock#grow}
	 */
	public static final int CHORUS_FLOWER_GROWS = 1033;
	/**
	 * A chorus flower dies.
	 * <br>Plays the chorus flower death sound event.
	 * <p>Called by {@link net.minecraft.block.ChorusFlowerBlock#die(World, net.minecraft.util.math.BlockPos) ChorusFlowerBlock#die}
	 */
	public static final int CHORUS_FLOWER_DIES = 1034;
	/**
	 * A brewing stand brews.
	 * <br>Plays the brewing stand brewing sound event.
	 * <p>Called by {@link net.minecraft.block.entity.BrewingStandBlockEntity#craft(World, net.minecraft.util.math.BlockPos, net.minecraft.util.collection.DefaultedList) BrewingStandBlockEntity#craft}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.LecternBlock#setPowered(World, net.minecraft.util.math.BlockPos, net.minecraft.block.BlockState) LecternBlock#setPowered}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.PointedDripstoneBlock#onDestroyedOnLanding(World, net.minecraft.util.math.BlockPos, net.minecraft.entity.FallingBlockEntity) PointedDripstoneBlock#onDestroyedOnLanding}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.CauldronBlock#fillFromDripstone(net.minecraft.block.BlockState, World, net.minecraft.util.math.BlockPos, net.minecraft.fluid.Fluid) CauldronBlock#fillFromDripstone}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.CauldronBlock#fillFromDripstone(net.minecraft.block.BlockState, World, net.minecraft.util.math.BlockPos, net.minecraft.fluid.Fluid) CauldronBlock#fillFromDripstone},
	 * and {@link net.minecraft.block.LeveledCauldronBlock#fillFromDripstone(net.minecraft.block.BlockState, World, net.minecraft.util.math.BlockPos, net.minecraft.fluid.Fluid) LeveledCauldronBlock#fillFromDripstone}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.ComposterBlock#onUse(net.minecraft.block.BlockState, World, net.minecraft.util.math.BlockPos, net.minecraft.entity.player.PlayerEntity, net.minecraft.util.Hand, net.minecraft.util.hit.BlockHitResult) ComposterBlock#onUse},
	 ...
	 * <p>Called by {@link net.minecraft.block.FluidBlock#playExtinguishSound(WorldAccess, net.minecraft.util.math.BlockPos) FluidBlock#playExtinguishSound},
	 * and {@link net.minecraft.fluid.LavaFluid#playExtinguishEvent(WorldAccess, net.minecraft.util.math.BlockPos) LavaFluid#playExtinguishEvent}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.Block#spawnBreakParticles(World, net.minecraft.entity.player.PlayerEntity, net.minecraft.util.math.BlockPos, net.minecraft.block.BlockState) Block#spawnBreakParticles},
	 * {@link net.minecraft.block.TallPlantBlock#onBreakInCreative(World, net.minecraft.util.math.BlockPos, net.minecraft.block.BlockState, net.minecraft.entity.player.PlayerEntity) TallPlantBlock#onBreakInCreative},
	 * {@link net.minecraft.entity.ai.goal.BreakDoorGoal#tick() BreakDoorGoal#tick},
	 * {@link net.minecraft.block.CarvedPumpkinBlock#trySpawnEntity(World, net.minecraft.util.math.BlockPos) CarvedPumpkinBlock#trySpawnEntity},
	 ...
	 * {@link net.minecraft.block.PowderSnowBlock#tryDrainFluid(WorldAccess, net.minecraft.util.math.BlockPos, net.minecraft.block.BlockState) PowderSnowBlock#tryDrainFluid},
	 * {@link net.minecraft.entity.passive.RabbitEntity.EatCarrotCropGoal#tick() RabbitEntity.EatCarrotCropGoal#tick},
	 * {@link net.minecraft.block.SpongeBlock#update(World, net.minecraft.util.math.BlockPos) SpongeBlock#update},
	 * {@link net.minecraft.block.TurtleEggBlock#breakEgg(World, net.minecraft.util.math.BlockPos, net.minecraft.block.BlockState) TurtleEggBlock#breakEgg},
	 ...
	 * {@link net.minecraft.block.WitherSkullBlock#onPlaced(World, net.minecraft.util.math.BlockPos, net.minecraft.block.entity.SkullBlockEntity) WitherSkullBlock#onPlaced},
	 * and {@link World#breakBlock(net.minecraft.util.math.BlockPos, boolean, net.minecraft.entity.Entity, int) World#breakBlock}
	 */
	 ...
	 * <p>Called by {@link MobSpawnerLogic#serverTick(net.minecraft.server.world.ServerWorld, net.minecraft.util.math.BlockPos) MobSpawnerLogic#serverTick}
	 */
	 ...
	 * and {@link net.minecraft.block.TurtleEggBlock#onBlockAdded(net.minecraft.block.BlockState, World, net.minecraft.util.math.BlockPos, net.minecraft.block.BlockState, boolean) TurtleEggBlock#onBlockAdded}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.WetSpongeBlock#onBlockAdded(net.minecraft.block.BlockState, World, net.minecraft.util.math.BlockPos, net.minecraft.block.BlockState, boolean) WetSpongeBlock#onBlockAdded}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.LightningRodBlock#setPowered(net.minecraft.block.BlockState, World, net.minecraft.util.math.BlockPos) LightningRodBlock#setPowered},
	 * and {@link net.minecraft.entity.LightningEntity#cleanOxidationAround(World, net.minecraft.util.math.BlockPos) LightningEntity#cleanOxidationAround}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.entity.SculkSpreadManager#tick(WorldAccess, net.minecraft.util.math.BlockPos,  net.minecraft.util.math.random.Random, boolean) SculkSpreadManager#tick}
	 */
	 ...
	 * <p>Called by {@link net.minecraft.block.SnifferEggBlock#onBlockAdded(net.minecraft.block.BlockState, World, net.minecraft.util.math.BlockPos, net.minecraft.block.BlockState, boolean) SnifferEggBlock#onBlockAdded}
	 */
