...
public class WorldChunk extends Chunk {
	...
	private final Map<BlockPos, WrappedBlockEntityTickInvoker> blockEntityTickers = Maps.<BlockPos, WrappedBlockEntityTickInvoker>newHashMap();
	...
	public TickSchedulers getTickSchedulers() {
		return new TickSchedulers(this.blockTickScheduler, this.fluidTickScheduler);
	}
