...
public class ChunkStatus {
	 ...
	 */
	private static final LoadTask STATUS_BUMP_LOAD_TASK = (targetStatus, world, structureTemplateManager, lightingProvider, fullChunkConverter, chunk) -> CompletableFuture.completedFuture(
			Either.left(chunk)
		);
	public static final ChunkStatus EMPTY = register(
		"empty", null, -1, PRE_CARVER_HEIGHTMAPS, ChunkType.PROTOCHUNK, (targetStatus, world, chunkGenerator, chunks, chunk) -> {
		}
	);
	...
	public static final ChunkStatus STRUCTURE_REFERENCES = register(
		"structure_references", STRUCTURE_STARTS, 8, PRE_CARVER_HEIGHTMAPS, ChunkType.PROTOCHUNK, (targetStatus, world, generator, chunks, chunk) -> {
	...
	public static final ChunkStatus SURFACE = register(
		"surface", NOISE, 8, PRE_CARVER_HEIGHTMAPS, ChunkType.PROTOCHUNK, (targetStatus, world, generator, chunks, chunk) -> {
			ChunkRegion chunkRegion = new ChunkRegion(world, chunks, targetStatus, 0);
	...
	public static final ChunkStatus SPAWN = register(
		"spawn", LIGHT, 0, POST_CARVER_HEIGHTMAPS, ChunkType.PROTOCHUNK, (targetStatus, world, generator, chunks, chunk) -> {
