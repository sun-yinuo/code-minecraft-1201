...
public class EntityPropertiesLootCondition implements LootCondition {
	...
	public static Builder builder(LootContext.EntityTarget entity, EntityPredicate.Builder predicateBuilder) {
		return () -> new EntityPropertiesLootCondition(predicateBuilder.build(), entity);
	}

	public static Builder builder(LootContext.EntityTarget entity, EntityPredicate predicate) {
