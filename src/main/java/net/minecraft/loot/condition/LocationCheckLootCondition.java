...
public class LocationCheckLootCondition implements LootCondition {
	...
	public static Builder builder(LocationPredicate.Builder predicateBuilder) {
		return () -> new LocationCheckLootCondition(predicateBuilder.build(), BlockPos.ORIGIN);
	}

	public static Builder builder(LocationPredicate.Builder predicateBuilder, BlockPos pos) {
