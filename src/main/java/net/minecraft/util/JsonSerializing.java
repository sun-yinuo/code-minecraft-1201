...
public class JsonSerializing {
	public static <E, T extends JsonSerializableType<E>> SerializerBuilder<E, T> createSerializerBuilder(
	...
	static class GsonSerializer<E, T extends JsonSerializableType<E>> implements JsonDeserializer<E>, com.google.gson.JsonSerializer<E> {
		...
		@Nullable
		private final com.mojang.datafixers.util.Pair<T, ElementSerializer<? extends E>> elementSerializer;
		...
		GsonSerializer(
			...
			@Nullable com.mojang.datafixers.util.Pair<T, ElementSerializer<? extends E>> elementSerializer
		) {
	...
	public static class SerializerBuilder<E, T extends JsonSerializableType<E>> {
		...
		private final Function<E, T> typeGetter;
		@Nullable
		private com.mojang.datafixers.util.Pair<T, ElementSerializer<? extends E>> elementSerializer;
		@Nullable
