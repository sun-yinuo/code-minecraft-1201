...
public class JigsawBlockEntity extends BlockEntity {
	...
	public void readNbt(NbtCompound nbt) {
		...
		this.joint = (Joint) Joint.byName(nbt.getString("joint"))
			.orElseGet(() -> JigsawBlock.getFacing(this.getCachedState()).getAxis().isHorizontal() ? Joint.ALIGNED : Joint.ROLLABLE);
	}
