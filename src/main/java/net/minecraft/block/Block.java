 ...
 * instance is registered under {@link Registries#BLOCK}.
 * See {@link Blocks} for examples of block instances.
 * 
 * <p>An item corresponding to a block is not automatically created. You
 * may create your own {@link BlockItem} and register it
 * under {@link Registries#ITEM}.
 * 
...
public class Block extends AbstractBlock implements ItemConvertible, FabricBlock {
	...
	public static boolean shouldDrawSide(BlockState state, BlockView world, BlockPos pos, Direction side, BlockPos otherPos) {
		...
		if (state.isSideInvisible(blockState, side)) {
			...
			Object2ByteLinkedOpenHashMap<NeighborGroup> object2ByteLinkedOpenHashMap = (Object2ByteLinkedOpenHashMap<NeighborGroup>)FACE_CULL_MAP.get();
	 ...
	 * GameRules#DO_TILE_DROPS doTileDrops} is turned off. For blocks that do
	 ...
	 * By default, this increments {@link Stats#MINED}, adds exhaustion
	 ...
	 * corresponding {@link BlockItem}, such as crops, should
	 ...
	 * GameRules#RANDOM_TICK_SPEED randomTickSpeed} game rule, and {@link
	 * Settings#ticksRandomly} block setting is not required.
	 * 
	 ...
	 * BlockItem block item}. Used by shulker boxes.
	 * 
	 ...
	 * is enchanted with silk touch or if {@link GameRules#DO_TILE_DROPS doTileDrops}
	 * is turned off.
	 * 
	 * @see AbstractBlock#onStacksDropped
	 * @see #dropExperience
	...
	public static final class NeighborGroup {
		...
		public boolean equals(Object o) {
			if (this == o) {
				...
				return !(o instanceof NeighborGroup neighborGroup)
					? false
